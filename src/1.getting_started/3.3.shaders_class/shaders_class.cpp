...
constexpr char* VERTEX_SHADER_FILE_NAME = "3.3.shader.vs";
constexpr char* FRAGMENT_SHADER_FILE_NAME = "3.3.shader.fs";
...
int main()
{
    ...
    // ------------------------------------
    Shader ourShader(VERTEX_SHADER_FILE_NAME, FRAGMENT_SHADER_FILE_NAME);
