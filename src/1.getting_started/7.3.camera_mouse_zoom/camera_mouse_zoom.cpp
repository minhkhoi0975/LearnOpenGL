...
#include <learnopengl/vertex_specification.h>
...
int main()
{
    ...
    for (int i = 0; i < 10; ++i)
    {
        cubeTransforms[i].rotation = glm::vec3(20.0f * i, 20.0f * i, 20.0f * i);
    }
    ...
    vertexSpecification.AddVertexAttribute(ElementType::Float, 3);
    vertexSpecification.AddVertexAttribute(ElementType::Float, 2);
    vertexSpecification.Apply();

    Texture texture1;
    texture1.Init(FileSystem::getPath("resources/textures/container.jpg").c_str());
    Texture texture2;
    texture2.Init(FileSystem::getPath("resources/textures/awesomeface.png").c_str(), true);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        {
            glm::mat4 model = cubeTransforms[i].GetModelMatrix();
